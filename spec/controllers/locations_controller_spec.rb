...
describe LocationsController do
  ...
  let(:valid_attributes) { { "urn" => "MyString" } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested location" do
        ...
        Location.any_instance.should_receive(:update).with({ "urn" => "MyString" })
        put :update, {:id => location.to_param, :location => { "urn" => "MyString" }}, valid_session
      end
